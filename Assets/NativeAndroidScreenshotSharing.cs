...
public class NativeAndroidScreenshotSharing : MonoBehaviour
{
    ...
    public void OnShareButtonClick()
    {
        ...
        shareSubject = "I dare you";
        shareMessage = "I dare you to beat my score in ADDA if you can..... " +
        "Get the ADDA from the link below." +
        "\nhttps://play.google.com/store/apps/details?id=com.ulkagames.callbridge";
